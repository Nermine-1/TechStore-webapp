        ...
        {loading ? (
          ...
          <>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+50% Incomes</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-100">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">-13% Sales</p>
            </CardContent>
          </Card>
          <Card className="bg-green-100">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">Daily User</CardTitle>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="h-4 w-4 text-muted-foreground">
                <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
                <circle cx="9" cy="7" r="4" />
                <path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />
            ...
            <CardContent>
              <div className="text-2xl font-bold">4215</div>
              <p className="text-xs text-muted-foreground">+48% New User</p>
            </CardContent>
          </Card>
          <Card className="bg-blue-100">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+25% New Product</p>
            </CardContent>
          </Card>
          <Card className="bg-yellow-100">
            ...
            <CardContent>
              <div className="text-2xl font-bold">$219.0</div>
              <p className="text-xs text-muted-foreground">Target Expenses</p>
            </CardContent>
          </Card>
        </div>
        <Card className="mb-8">
